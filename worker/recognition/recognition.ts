    ...
    messages: [
      {
        ...
        content:
          ...
          'dish は大まかな料理分類で、各行は [ID,分類名,検索語の配列] です。検索語には分類に含まれる具体的な料理名もあります。' +
          '写真から具材や調理法が十分に確認できる場合だけ recipe を選び、それ以外は dish から選んでください。' +
          '料理分類は細かな味付けで分けません。ペペロンチーノやカルボナーラは generic-pasta、パンの種類は generic-bread です。' +
          '具体的な料理名はレシピカードの recipe で扱い、分類IDを新しく作らないでください。' +
