...
const descriptions: Record<SpeciesId, readonly string[]> = {
  komugi: [
    'ころんとした麦粒の体。手足も耳も、まだ小さなふくらみ。',
    '丸い耳と短い手足が生えた。おなかは焼きたてパンのよう。',
    '大きなほっぺと前足で踏んばる。しっぽの先に麦の穂が育つ。',
    '胸を張って立つ、たくましい体。麦色の胸毛と太い尾を持つ。',
    '麦の穂が連なる大きな鬣。豊かな尾とがっしりした四肢を持つ。',
  ],
  mame: [
    'ひと粒のそら豆みたいな体。背中に小さな豆のすじがある。',
    '小さな葉の耳と丸い後ろ足。豆のようなおなかで座る。',
    '耳が長い二枚の葉に育つ。大きな後ろ足でぴょんと跳ねる。',
    'すらりと長い脚と胴体。首元の葉としなやかな耳が揺れる。',
    '枝分かれした葉の耳と広がる葉の胸毛。豆房の尾がくるりと伸びる。',
  ],
  shizuku: [
    'ひと雫のような青い体。小さなくちばしがちょこんとのぞく。',
    '丸い頭とふっくらしたおなか。小さな翼と水かきが生えた。',
    '翼と三つに分かれた尾羽が育つ。胸元には白い波の模様。',
    '首と脚が長く伸びた水鳥。長い翼をたたんで静かに立つ。',
    '水しぶきの冠と扇のような尾羽。大きな翼が波形に広がる。',
  ],
  yuzu: [
    'ゆずの実みたいな丸い体。頭に小さな葉が一枚。',
    '三角の耳と短いしっぽが生えた。まだ手足はころころ。',
    '大きな耳と細くなった顔。白い尾先のしっぽが長く伸びる。',
    '長い脚とすっきりした鼻先。太い尾を背中まで巻き上げる。',
    'ゆずの房のように広がる三つ又の尾。頬と胸毛も大きく育つ。',
  ],
  momo: [
    '桃まんじゅうのようなふた山の体。手足はまだ見えない。',
    '小さな猫耳と手足が生えた。短いしっぽの先がくるん。',
    '丸い腰と大きな前足。しっぽを高く上げて遊びに誘う。',
    'しなやかな長い脚と胴体。胸毛と巻いた尾がふんわり育つ。',
    '桃の花びらのような大きな尾。頬と胸の毛が幾重にも広がる。',
  ],
  goma: [
    '丸い黒ごまみたいな体。白い顔が少しだけのぞいている。',
    'まん丸の頭と小さな翼。短い足でちょこんと立つ。',
    '幅広い顔と耳羽が育った。白いハート型の顔が目印。',
    '背の高い体と長くたたんだ翼。胸にごま粒の模様が並ぶ。',
    '大きな耳羽と扇状に広がる翼。堂々とした胸には白ごまの模様。',
  ],
}
