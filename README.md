...
認識対象は`shared/content/recipes.ts`の310種のレシピと、`shared/content/dishes.ts`の201種の料理です。ごはん・麺・パンや粉もの・肉・魚介・卵や豆・野菜や副菜・汁物や鍋・おやつや果物・その他のおかずの10分類で、具体的なレシピを特定できなくても、餃子・唐揚げ・寿司・オムライスなどの名前で記録できます。「料理を選ぶ」では名前・読み・別名で検索し、種類で絞り込んで12件ずつ閲覧できます。種類での記録は通常の経験値と毎日の報酬を獲得し、料理カードは具体的なレシピを選んだ場合に獲得します。
